<script>
  ...
  export let shareUrl;
  export let tnlPageId;
  export let iconColor = '#484748';
...
{:else}
  <div class="flex mx-auto">
    ...
    <a href={`${shareUrl}`} target="_blank" class="px-2 hover:opacity-50">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
    ...
    <a
      ...
      <svg
        ...
        width="24"
        height="24"
        viewBox="0 0 157.32 126.73"><path
